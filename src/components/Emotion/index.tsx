  ...
  return (
    <div>
      <ul className="flex gap-2 text-center">
        <li onClick={() => handleEmotion('moved')} className="text-[#999999] hover:text-sub-blue-1">
        ...
        <li onClick={() => handleEmotion('happy')} className="text-[#999999] hover:text-sub-blue-1">
        ...
        <li onClick={() => handleEmotion('angry')} className="text-[#999999] hover:text-sub-blue-1">
