...
type Props = {
  onPick: (emotion: EmotionCode) => void;
};

const Emotion = ({ onPick }: Props) => {
  const { t } = useTranslation('emotion');

  return (
    <div>
      <ul className="flex gap-2 text-center">
        <li onClick={() => onPick('MOVED')} className="text-[#999999] hover:text-sub-blue-1">
        ...
        <li onClick={() => onPick('HAPPY')} className="text-[#999999] hover:text-sub-blue-1">
        ...
        <li onClick={() => onPick('WORRIED')} className="text-[#999999] hover:text-sub-blue-1">
          ...
          <span className="text-xs-sb md:text-md-sb lg:text-xl-sb">{t('worried')}</span>
        </li>
        <li onClick={() => onPick('SAD')} className="text-[#999999] hover:text-sub-blue-1">
        ...
        <li onClick={() => onPick('ANGRY')} className="text-[#999999] hover:text-sub-blue-1">
